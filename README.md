...
While this is mostly a project pursued out of the curiosity I have for particle simulation I will be using it as an opportunity to practice three main things
  1) using java script (a language I have only dipped my toes in)
  2) using lazy vim
  3) using git


another video that inspired me was by Sebastien Lague. He has some amazing stuff so go check out his channel (specifically his fluid sim series)
  https://youtu.be/rSKMYc1CQHE?si=NGSvCXMHm5RGs7-n
